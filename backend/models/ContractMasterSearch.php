...
class ContractMasterSearch extends ContractMaster
{
    ...
    {
        return [
            [['contract_ref_no', 'branch', 'product', 'product_type', 'module', 'payment_method', 'customer_number', 'booking_date', 'value_date', 'maturity_date', 'main_component', 'contract_status', 'maker_id', 'maker_stamptime', 'checker_id', 'checker_stamptime'], 'safe'],
